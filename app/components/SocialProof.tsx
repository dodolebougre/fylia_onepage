...
const SocialProof = () => {
  return (
    <div className="text-white flex flex-col items-center m-10">
      <h2 className="text-center text-2xl mb-3 md:text-2xl lg:text-3xl w-[400px]  font-semibold "
      ...
      <section className="">
        ...
        <div className="flex flex-col items-center  ">
          <figure className="flex flex-col  bg-opacity-10 bg-white rounded p-4 backdrop-blur text-2xl text-center m-10 shadow duration-300 transform hover:scale-110 w-[400px] lg:w-[500px]">
