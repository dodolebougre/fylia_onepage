...
const Cta2 = () => {
  return (
    <div className="flex flex-col text-center items-center justify-center text-white mt-20 mb-10 ">
      ...
      <img className="w-4/5" src="/assets/image/Notreequipe.png" alt="" />
      <div className="flex flex-col  bg-opacity-10 bg-white rounded p-4 backdrop-blur text-2xl text-center w-[400px] lg:w-[500px] m-20 shadow">
