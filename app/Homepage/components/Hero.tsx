    ...
    <div id="hero">
      <div className="flex items-center justify-center h-screen lg:mb-11  md:mb-11 sm:mb-11 mb-[-120px] ">
        ...
        <div
          ...
          style={{
            backgroundImage: 'url("https://images.unsplash.com/photo-1551124190-343f48f285fa?q=80&w=2938&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")',
